    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mb-12">
            <div class="flex items-center gap-4 mb-2">
                <a href="/admin/users" class="text-slate-400 hover:text-orange-600 transition"><i class="fas fa-arrow-left"></i></a>
            ...
            <form action="" method="POST" class="space-y-8">
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <select id="role" name="role" class="w-full px-6 py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-2 focus:ring-orange-500 focus:outline-none transition appearance-none">
                    ...
                    <div>
                        <label for="password" class="block text-sm font-bold text-slate-700 mb-2"><?php echo $id ? 'New Password (leave blank to keep current)' : 'Password'; ?></label>
                        <input type="password" id="password" name="password" class="w-full px-6 py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-2 focus:ring-orange-500 focus:outline-none transition">
                    </div>
                </div>
                ...
                <div class="pt-8 border-t border-slate-100 flex gap-4">
                    ...
                    <a href="/admin/users" class="px-8 py-4 rounded-2xl font-bold text-slate-600 bg-slate-100 hover:bg-slate-200 transition">
                        Cancel
                    </a>
                </div>
            </form>
